...
describe('Date Functions', () => {
    it('forms a timestamp correctly', () => {
        expect(Timestamp(new Date(2021, 11, 25))).to.equal('2021-12-25')
    })

    it('extracts a date correctly', () => {
